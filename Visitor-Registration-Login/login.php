...
<body>
    <div class="hero">
        ...
        <div class="form">
            ...
            <form class="form-flex" action="user-login.php" method="POST">
                <input class="flex-items" name="email" type="text" placeholder="Email">
                <input class="flex-items" name="password" type="password" placeholder="Password">
