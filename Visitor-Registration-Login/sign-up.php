...
<body>
    <div class="hero">
        ...
        <div class="form">
            ...
            <form class="form-flex" action="user-registration.php" method="POST">
                <input class="flex-items" type="text" name="first_name" placeholder="First Name">
                <input class="flex-items" type="text" name="last_name" placeholder="Last Name">
                <input class="flex-items" type="text" name="email" placeholder="Email">
                <input class="flex-items" type="text" name="phone_number" placeholder="Phone Number">
                <input class="flex-items" type="text" name="address" placeholder="Address">
                <input class="flex-items" type="password" name="password" placeholder="Password">

                <input class="flex-items register-button" type="submit" value="Sign Up">
            </form>
